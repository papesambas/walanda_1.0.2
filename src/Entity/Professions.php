...
class Professions implements TimestampedInterface
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\OneToMany(mappedBy: 'profession', targetEntity: Personnels::class)]
    ...
    public function removePersonnel(Personnels $personnel): self
    {
        if ($this->personnels->removeElement($personnel)) {
            ...
            if ($personnel->getProfession() === $this) {
                $personnel->setProfession(null);
            }
        }
